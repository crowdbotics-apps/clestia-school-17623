"""clestia_school_17623 URL Configuration
...
admin.site.site_header = "Clestia School"
admin.site.site_title = "Clestia School Admin Portal"
admin.site.index_title = "Clestia School Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Clestia School API",
        default_version="v1",
        description="API documentation for Clestia School App",
    ),
    public=True,
